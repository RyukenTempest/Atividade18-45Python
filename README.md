...
38. Receba 100 números inteiros reais. Verifique e mostre o maior e o menor valor. Obs.:
somente valores positivos.
39. Calcule a quantidade de grãos contidos em um tabuleiro de xadrez onde:
Casa: 1 2 3 4 ... 64
Qdte: 1 2 4 8 ... N
40. Receba 2 números inteiros. Verifique e mostre todos os números primos existentes entre
eles.
...
Parte 2 - Docker
Criar um contêiner da imagem Docker Python, Tag 3.10.20, mapear o volume do hospedeiro com
a pasta dos projetos da Parte 1, rodar 1 deles no contêiner.
A resposta deve ter prints do comando docker de criação do contêiner, do comando docker de
execução da aplicação e do terminal com a aplicação em execução.
